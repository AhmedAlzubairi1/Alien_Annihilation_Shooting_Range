//Coded by Ahmed Alzubairi, Rami Matar, and James Bollas (AOE Fall 2018)

//Note I used https://gist.github.com/nicksort/4736535 for the exact tones for the StarWars theme song for the Piezo buzzer.
